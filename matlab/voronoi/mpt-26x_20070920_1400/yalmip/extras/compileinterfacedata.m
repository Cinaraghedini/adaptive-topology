...
% *************************************************************************
[ProblemClass,integer_variables,binary_variables,parametric_variables,uncertain_variables,quad_info] = categorizeproblem(F,P,h,options.relax,parametric,evaluation_based,F_vars);
...
try
    ...
    if strcmpi(solver.tag,'bmibnb') | strcmpi(solver.tag,'pennlp-standard') | strcmpi(solver.tag,'fmincon-geometric')| strcmpi(solver.tag,'gpposy') | evaluation_based;
        tempoptions = options;
        tempoptions.relax = 1;
